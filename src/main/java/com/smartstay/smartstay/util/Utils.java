...
public class Utils {
    ...
    public static final String BANKING_METHOD_PAYMENT_METHOD_INVALID = "Payment method should be UPI, Credit Card, Debit Card or QR Code";
    public static final String BANKING_METHOD_ONLY_FOR_BANK = "Payment methods can only be added to a BANK account";
    public static final String BANKING_METHOD_DISPLAY_NAME_REQUIRED = "Display name is required";
    public static final String BANKING_METHOD_UPI_ID_REQUIRED = "UPI id is required for UPI";
    public static final String BANKING_METHOD_UPI_APP_REQUIRED = "UPI app is required for UPI and QR Code";
    public static final String BANKING_METHOD_CARD_NUMBER_REQUIRED = "Card number is required";
    public static final String BANKING_METHOD_CARD_NUMBER_INVALID = "Card number must be at least 4 digits";
    public static final String BANKING_METHOD_CARD_NETWORK_REQUIRED = "Card network is required for Credit Card and Debit Card";
    public static final String BANKING_METHOD_CARD_HOLDER_REQUIRED = "Card holder name is required for Credit Card and Debit Card";
    public static final String BANKING_METHOD_LINKED_UPI_REQUIRED = "Linked UPI id is required for QR Code";
    public static final String BANKING_METHOD_QR_IMAGE_REQUIRED = "QR image is required for QR Code";
    public static final String BANKING_METHOD_IMAGE_INVALID = "QR image must be a valid image file";
    ...
    public static final String TRANSFER_AMOUNT_REQUIRED = "Transfer amount is required";
    ...
    public static final String CANNOT_APPLY_TO_BOOKING_INVOICE = "Cannot apply to booking invoice";
