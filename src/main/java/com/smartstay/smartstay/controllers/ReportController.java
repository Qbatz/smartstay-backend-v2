...
public class ReportController {
    ...
    public ResponseEntity<?> getInvoiceReportDetails(@PathVariable("hostelId") String hostelId,
        ...
        return reportService.getInvoiceReportDetails(hostelId, search, paymentStatus, invoiceModes, invoiceTypes,
                createdBy, period, minPaidAmount, maxPaidAmount, minOutstandingAmount, maxOutstandingAmount, startDate,
                endDate, page, size);
    }
    ...
    public ResponseEntity<?> getTenantRegisterDetails(@PathVariable("hostelId") String hostelId,
            ...
            @RequestParam(value = "page", defaultValue = "0") int page,
            @RequestParam(value = "size", defaultValue = "10") int size) {
        return reportService.getTenantRegister(hostelId, search, status, room, floor, period, startDate, endDate, page,
                size);
    }
}
