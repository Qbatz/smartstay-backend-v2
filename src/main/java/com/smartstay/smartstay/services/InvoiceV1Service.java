...
public class InvoiceV1Service {
    ...
    public void createSettlementInvoice(Customers customers, String hostelId, double totalAmountToBePaid,
    ...
    public Double createNewInvoice(InvoicesV1 oldInvoice, String joiningDate, Double rent, BillingDates billingDates,
    ...
    public ResponseEntity<?> generateRecurringManually(String hostelId) {
        ...
        List<com.smartstay.smartstay.dao.BillingRules> listBillingRules = hostelService
                .findAllHostelsHavingBillingToday();
