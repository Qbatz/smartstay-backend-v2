...
public class FloorsService {
    ...
    public ResponseEntity<?> getAllFloors(String hostelId) {
        ...
        List<Floors> listFloor = floorRepository.findAllByHostelId(hostelId);
    ...
    public ResponseEntity<?> getFloorById(Integer id) {
        ...
        Floors floors = floorRepository.findById(id).orElse(null);
        if (floors != null) {
    ...
    public ResponseEntity<?> updateFloorById(int floorId, UpdateFloor updateFloor) {
        ...
        Floors existingFloor = floorRepository.findById(floorId).orElse(null);
        ...
        if (updateFloor.isDeleted() != null) {
            existingFloor.setIsDeleted(updateFloor.isDeleted());
        }
    ...
    public ResponseEntity<?> addFloor(AddFloors addFloors) {
        ...
        HostelV1 hostelV1 = hostelV1Repository.findByHostelId(addFloors.hostelId());
        if (hostelV1==null){
